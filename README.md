...
Сделано:
Выкачивание ЖЖ (отброшено, поскольку получен доступ к материалам ГИКРЯ)
Получен список ГИКРЯ
Запросили доступ к серверу ВШЭ
Добавлена первая версия программы для удаления повторов в списке
